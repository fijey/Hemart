                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" class="product-thumbs-track ps-slider">
                                    <div class="pt" @click="changeImage(gambar_thumbs[0])" :class="gambar_default == gambar_thumbs[0] ? 'active' : '' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(gambar_thumbs[1])" :class="gambar_default == gambar_thumbs[1] ? 'active' : '' ">
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(gambar_thumbs[2])" :class="gambar_default == gambar_thumbs[2] ? 'active' : '' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt" @click="changeImage(gambar_thumbs[1])" :class="gambar_default == gambar_thumbs[3] ? 'active' : '' ">
